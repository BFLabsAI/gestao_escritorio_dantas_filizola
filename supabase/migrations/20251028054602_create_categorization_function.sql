-- Function para popular a tabela de vínculos baseado na categoria
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      SELECT EXISTS(
        SELECT 1 FROM profissional_procedimento_agenda_inteligente_orus 
        WHERE profissional_id = prof_record.id 
          AND procedimento_id = proc_record.id
