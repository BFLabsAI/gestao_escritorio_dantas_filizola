...
BEGIN
  ...
  SELECT id INTO v_plan_id FROM saas_plans WHERE slug = 'enterprise';
  IF v_plan_id IS NULL THEN
     INSERT INTO saas_plans (name, slug, max_instances, max_messages_month) VALUES ('Enterprise', 'enterprise', 50, 1000000) RETURNING id INTO v_plan_id;
  END IF;

  -- 2. Create Tenant 'R7 Treinamentos'
  INSERT INTO saas_tenants (name, slug, plan_id, status)
  VALUES ('R7 Treinamentos', 'r7-treinamentos', v_plan_id, 'active')
  ON CONFLICT (slug) DO UPDATE SET name = EXCLUDED.name
  RETURNING id INTO v_tenant_id;

  -- 3. Migrate Message Logs
  INSERT INTO saas_message_logs (
  ...
  -- 4. Migrate Schedules
  -- Note: Handling jsonb array to text array conversion
  INSERT INTO saas_schedules (
  ...
  INSERT INTO saas_chat_sessions (
  ...
  INSERT INTO saas_chat_messages (
  ...
  INSERT INTO saas_instances (tenant_id, instance_name, status, connection_status)
